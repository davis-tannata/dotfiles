...
-- Same pickers but including .gitignore'd + hidden files (or press ctrl-g /
-- ctrl-y inside any files/grep picker to toggle ignore / hidden mid-search).
vim.keymap.set("n", "<leader>pF", function()
    fzf.files({ no_ignore = true, hidden = true })
end, { desc = "fzf find files (incl. ignored + hidden)" })
vim.keymap.set("n", "<leader>pG", function()
    fzf.live_grep({ no_ignore = true, hidden = true })
end, { desc = "fzf live grep (incl. ignored + hidden)" })
